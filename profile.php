...
<title>العميد لتأجير السيارات | الملف الشخصي</title>
<!--Bootstrap -->
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-8">
        <div class="profile_wrap">
          <h5 class="uppercase underline">الإعدادات العامة</h5>
          <?php  
         if($msg){?><div class="succWrap"><strong>تم بنجاح</strong>:<?php echo htmlentities($msg); ?> </div><?php }?>
          <form  method="post">
           <div class="form-group">
            ...
            <div class="form-group">
              <label class="control-label">آخر تحديث في  -</label>
             <?php echo htmlentities($result->UpdationDate);?>
            </div>
            <?php } ?>
            <div class="form-group">
              <label class="control-label">الأسم الكامل </label>
            ...
            <div class="form-group">
              <label class="control-label">تاريخ الميلاد&nbsp;(dd/mm/yyyy)</label>
            ...
            <div class="form-group">
              <button type="submit" name="updateprofile" class="btn">حفظ التغييرات <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></button>
            </div>
          </form>
        </div>
      </div>
