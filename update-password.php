...
<title>العميد لتأجير السيارات | إعادة تعيين كلمة المرور</title>
<!--Bootstrap -->
...
<form name="chngpwd" method="post" onSubmit="return valid();">
            ...
            <div class="form-group">
               <input type="submit" value="حفظ التغييرات" name="update" id="submit" class="btn btn-block">
            </div>
          </form>
        </div>
      </div>
